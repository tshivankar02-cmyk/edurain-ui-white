    ...
    <div className="space-y-6 pb-20 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {activeCourses.map((course) => (
          <div
            key={course.id}
            className="rounded-2xl bg-[#EAE3DE]/35 hover:bg-[#EAE3DE]/50 border border-[#175A67]/20 p-5 backdrop-blur-md shadow-sm flex flex-col justify-between transition-all duration-300 hover:-translate-y-1"
          >
            <div>
              ...
              <p className="text-xs text-[#2A707C] mt-1">{course.instructor}</p>

              <div className="mt-4 p-3 rounded-xl bg-white/40 border border-[#175A67]/15">
